<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AGPOT.aspx.cs" Inherits="ASP_Begin.AGPOT" EnableEventValidation = "false" %>
            ...
            <tr>
                ...
                <td align="right">
                  <asp:Button ID="btnPrintPDF" runat="server" CssClass="submitbutton"
                        Text="Export to Excel" Width="107px" />
                </td>
            </tr>
        </table>
                ...
                <tr align="right">
                    <td class="style4" align="left">
                        ...
                        <div id="Div1" style="text-align: right; float: right; font-weight: bold; font-size: large; font-family: Tahoma" runat="server">
                            <asp:Label runat="server" ID="Label1" Text="Non Verified OT hour report " Font-Names="TAHOMA" Font-Bold="true" Font-Size="Large" /><br />
